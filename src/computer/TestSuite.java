...
public class TestSuite extends Utility {
    ...
    public void verifyProductAddedToShoppingCartSuccessFully() throws InterruptedException {
        ...
        sendTextToElement(By.id("BillingNewAddress_FirstName"), "Khushi");
        sendTextToElement(By.id("BillingNewAddress_LastName"), "Pandey");
        sendTextToElement(By.id("BillingNewAddress_Email"), "khushi123@gmail.com");
        selectByVisibleTextFromDropDown(By.xpath("//select[@id='BillingNewAddress_CountryId']"), "United Kingdom");
        sendTextToElement(By.id("BillingNewAddress_City"), "London");
        sendTextToElement(By.id("BillingNewAddress_Address1"), "32 Waverly Road");
        sendTextToElement(By.id("BillingNewAddress_ZipPostalCode"), "HA2 9RE");
        sendTextToElement(By.id("BillingNewAddress_PhoneNumber"), "07448443314");
        ...
        sendTextToElement(By.id("CardholderName"), "Ms Khushi");
        sendTextToElement(By.id("CardNumber"), "3200 2000 0000 0222");
